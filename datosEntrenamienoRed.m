...
deDosEnDos = [manoDerecha(:,1:2:28) manoIzquierda(:,1:2:28) pies(:,1:2:24)];
deTresEnTres = [manoDerecha(:,1:3:27) manoIzquierda(:,1:3:27) pies(:,1:3:21)];
...
variosDatos = [manoDerecha(:,1:28) manoIzquierda(:,1:28) pies(:,1:26)];
