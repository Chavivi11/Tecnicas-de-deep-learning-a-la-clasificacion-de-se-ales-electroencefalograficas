...
%     datosSujetos = zeros(13,5);
    sujetosCandidatos = zeros(1,12);
%     sujetosCandidatos = [17	28	107	1	33	55	24	72	7	62	44	5];
...
%         datosSujetos(f,:) = [sujetos tasaAcietoMD tasaFalloMD tasaAcietoMI tasaFalloMI];
...
%     datosSujetos(end, :) = [max(datosSujetos(:,1)) mean(datosSujetos(:,2)) mean(datosSujetos(:,3)) mean(datosSujetos(:,4)) mean(datosSujetos(:,5))];
